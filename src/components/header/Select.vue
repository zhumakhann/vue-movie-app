<template>
  <div class="header-select">
    <button class="header-select__button">
      <svg
        version="1.1"
      ...
      >
        <path
          d="M500.94,191.81H31.606c-5.888,0-10.667,4.779-10.667,10.667v256c0,29.397,23.915,53.333,53.333,53.333h384
        ...
        />
        <path
          d="M511.265,93.1L493.11,24.215C488.929,7.468,471.82-3.049,454.86,0.791L25.078,102.764
        ...
        />
        <path
          d="M121.718,192.919c-5.291-2.581-11.648-0.491-14.336,4.779l-42.667,85.333c-2.624,5.269-0.491,11.669,4.779,14.315
        ...
        />
        <path
          d="M228.364,192.919c-5.269-2.581-11.669-0.491-14.315,4.779l-42.667,85.333c-2.624,5.269-0.491,11.669,4.779,14.315
        ...
        />
        <path
          d="M335.03,192.919c-5.248-2.581-11.648-0.491-14.315,4.779l-42.667,85.333c-2.624,5.269-0.491,11.669,4.779,14.315
			c1.557,0.768,3.179,1.131,4.779,1.131c3.904,0,7.68-2.155,9.536-5.909l42.667-85.333
			C342.433,201.964,340.299,195.564,335.03,192.919z"
        />
        <path
          d="M441.697,192.919c-5.291-2.581-11.648-0.491-14.315,4.779l-42.667,85.333c-2.624,5.269-0.491,11.669,4.779,14.315
			c1.557,0.768,3.179,1.131,4.779,1.131c3.904,0,7.68-2.155,9.536-5.909l42.667-85.333
			C449.099,201.964,446.966,195.564,441.697,192.919z"
        />
        <path
          d="M500.94,277.143H31.606c-5.888,0-10.667,4.779-10.667,10.667s4.779,10.667,10.667,10.667H500.94
    ...
    <ul class="header-select__list">
      <li class="header-select__list-item">
...
.header-select__button:hover + .header-select__list{
  opacity: 1;
  visibility: visible;
}
.film-svg {
...
.header-select__list:hover{
  opacity: 1;
  visibility: visible;
}
.header-select__list-item{
}
.header-select__list-item a{
  display: block;
...
.header-select__list-item a:hover{
